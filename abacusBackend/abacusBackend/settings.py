"""
Django settings for abacusBackend project.
...
SECRET_KEY = 'django-insecure-f&ag!v&ja!pt%q7liq+vh_6vvem3bt+2j9@($z7klp+7d9lhn8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1","deco-websocket.onrender.com"]
